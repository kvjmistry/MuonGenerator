...
mkdir -p Muons/data/jobid_"${SLURM_ARRAY_TASK_ID}"
cd Muons/data/jobid_"${SLURM_ARRAY_TASK_ID}"
...
sed -i "s#.*angle_file.*#/Generator/MuonAngleGenerator/angle_file MuonAnaAllRuns.csv#" NEXT100_muons_hallA.config.mac
